   ...
   <div className="max-w-7xl mx-auto text-center flex flex-col items-center justify-center mt-8 sm:mt-12 md:mt-16 lg:mt-20">
     ...
     <div className="mt-4 sm:mt-6 mb-8 sm:mb-10">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg font-medium">Simple. Fast. Accessible.</p>
      </div>

      {/* Advantages Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* First Column - Two Cards of equal height */}
        <div className="flex flex-col gap-6 h-full">
          {/* SFX Reward Guarantee */}
          <div className="bg-white rounded-2xl p-6 flex-1 shadow-sm">
            <h3 className="text-xl font-bold mb-2">SFX Reward Guarantee</h3>
            <p className="text-gray-700 mb-4">
              Get paid in 48-HRS or we pay you $300 extra
            </p>
            <div className="flex justify-center">
              <CheckCircle size={64} className="text-fuchsia-500" strokeWidth={1.5} />
            </div>
          </div>
          
          {/* Simple Target */}
          <div className="bg-white rounded-2xl p-6 flex-1 shadow-sm">
            <h3 className="text-xl font-bold mb-2">Simple Target</h3>
            <p className="text-gray-700 mb-4">
              Hit Just 5% profit in the evaluation to get funded.
            </p>
            <div className="flex justify-center">
              <Rocket size={64} className="text-fuchsia-500" strokeWidth={1.5} />
            </div>
          </div>
        </div>

        {/* Middle Column - Three Cards of equal height */}
        <div className="flex flex-col gap-6 h-full">
          {/* First Payout On Demand */}
          <div className="bg-green-50 rounded-2xl p-6 flex-1 shadow-sm">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-xl font-bold text-green-700">First Payout On Demand</h3>
              <Banknote size={24} className="text-green-500" strokeWidth={2} />
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 flex-1 shadow-sm">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-xl font-bold">Fastest Evaluation Process</h3>
              <Clock size={24} className="text-gray-800" strokeWidth={2} />
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 flex-1 shadow-sm">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-xl font-bold">Up to 100% Performance Split</h3>
              <Banknote size={24} className="text-gray-800" strokeWidth={2} />
            </div>
            <p className="text-gray-700">
        ...
        {/* Third Column - Two Cards of 1/3 height each */}
        <div className="flex flex-col gap-6 h-full">
          {/* Funded Stage Reset */}
          <div className="bg-white rounded-2xl p-6 flex-1 shadow-sm">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-xl font-bold">Funded Stage Reset</h3>
          ...
          <div className="bg-white rounded-2xl p-6 flex-1 shadow-sm">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-xl font-bold text-fuchsia-500">Platform 5</h3>
              <Shield size={24} className="text-fuchsia-500" strokeWidth={2} />
            </div>
          ...
          {/* Empty space to match the height of other columns */}
