                    ...
                    <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
                        ...
                        <div className="lg:w-3/5 xl:w-2/3 space-y-6">
                            ...
                            <div className="p-6 sm:p-8 rounded-xl bg-[#F8EAF8] relative">
                                ...
                                <h3 className="text-xl sm:text-2xl font-bold mb-2">CHOOSE YOUR CHALLENGE</h3>
                                <p className="text-base text-gray-600">Pick the evaluation that fits your trading style.</p>
                            </div>
                            ...
                            <div className="p-6 sm:p-8 rounded-xl bg-blue-50 relative">
                                ...
                                <h3 className="text-xl sm:text-2xl font-bold mb-2">PASS THE 2-STEP EVALUATION</h3>
                                <p className="text-base text-gray-600">Complete two phases - simple target, fair rules.</p>
                            </div>
                            ...
                            <div className="p-6 sm:p-8 rounded-xl bg-green-50 relative">
                                ...
                                <h3 className="text-xl sm:text-2xl font-bold mb-2">GET FUNDED & START EARNING</h3>
                                <p className="text-base text-gray-600">Scale to $3.2 million in capital with up to 100% profit split</p>
                            </div>
                        </div>
                    </div>
                </div>
