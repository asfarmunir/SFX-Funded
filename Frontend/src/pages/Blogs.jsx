  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Monitoring your trade performance is essential if you want lasting success in trading. By keeping track of your trades, you...",
      image: "/blog.png",
    },
    {
      id: 2,
      ...
      >
        ...
        leading-none tracking-tight"
          ...
          <p className="text-white text-base sm:text-lg md:text-xl lg:text-2xl max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-3xl font-inter mb-8 sm:mb-10 md:mb-12">
            Explore the latest insights in forex trading and maximize your
            potential with SFX Funded.
          </p>
        </motion.div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="md:w-1/2 p-6">
            ...
            <button
              className="text-white py-2 px-4 rounded-full font-semibold text-sm hover:opacity-90 transition-opacity flex items-center gap-1"
              style={{
                fontFamily: "Inter, sans-serif",
          ...
          {regularPosts.map((post) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button
                  className="text-white py-1.5 pb-2 px-5 rounded-full 2xl:text-sm font-semibold text-xs hover:opacity-90 transition-opacity flex items-center gap-1"
                  style={{
                    fontFamily: "Inter, sans-serif",
                    backgroundColor: "rgba(248, 0, 234, 1)",
                  }}
          ...
          {["<", 1, 2, 3, 4, 5, ">"].map((val, index) => (
            <button
              ...
              style={{
                fontFamily: "Inter, sans-serif",
                backgroundColor:
                  val === 1 ? "rgba(248, 0, 234, 1)" : "transparent",
              }}
            >
              {val}
            </button>
