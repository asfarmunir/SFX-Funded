             ...
             <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
               ...
               <div className="lg:w-3/5 xl:w-2/3 space-y-6">
                 ...
                 <div className="p-6 sm:p-8 rounded-xl bg-[#F8EAF8] relative">
                   ...
                   <p className="text-base text-gray-600">Choose your preferred account size up to $40,000</p>
                 </div>
                 ...
                 <div className="p-6 sm:p-8 rounded-xl bg-blue-50 relative">
                   ...
                   <h3 className="text-xl sm:text-2xl font-bold mb-2">TRADE</h3>
                   <p className="text-base text-gray-600">Get instant access to your funded account and start trading immediately. No waiting, no targets.</p>
                 </div>
                 ...
                 <div className="p-6 sm:p-8 rounded-xl bg-green-50 relative">
                   ...
                   <h3 className="text-xl sm:text-2xl font-bold mb-2">EARN REWARD</h3>
                   <p className="text-base text-gray-600">Start earning from day one and receive up tp 100% reward split, Paid bi-weekly.</p>
                 </div>
               </div>
             </div>
           </div>
