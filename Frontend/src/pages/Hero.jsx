...
export const accountSizes = {
  ...
  instant: [2500, 5000, 10000, 20000, 40000, 80000],
};
export const cards = [
  {
    index: 0,
...
export default function Hero() {
  ...
  return (
    <div className="font-inter w-full">
      ...
      >
        ...
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center justify-center mt-4 sm:mt-6 md:mt-8 lg:mt-10">
          ...
          >
            ...
            <motion.div
              className="bg-white rounded-full flex items-center justify-center shadow-md mx-auto sm:mx-0 h-7 md:h-10 px-3 md:px-5  "
              style={{
      ...
      {/* PAYOUTS SECTION */}
      <div className="flex justify-center w-full max-w-7xl mx-auto px-4 mt-8 mb-8 sm:px-6 md:px-7 lg:px-10 ">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 py-4 bg-gray-50 rounded-[20px]  font-['Inter'] max-w-7xl w-full">
        ...
        {selectedProgram !== "instant" ? (
          ...
          >
            ...
            {tableRows.map((row, index) => (
              ...
              >
                <div className="py-3 pl-4 font-semibold">{row.label}</div>
                <div className="text-center font-semibold py-3">
                  {tableData[selectedProgram][selectedSize]?.phase1?.[
                    row.key
                  ] || "-"}
                </div>
                <p className="text-center font-semibold py-3">
                  {selectedProgram === "instant"
                    ? " "
                    : tableData[selectedProgram][selectedSize]?.phase2?.[
                        row.key
                      ] || " "}
                </p>
                <p className="text-center font-semibold py-3">
  ...
  `}
              ...
              >
                ...
                >
                  ...
                  <p className="font-medium mb-2">
                    Want to Fast Track The Evaluation?
                  </p>
                  <p className="text-sm">
                    Demonstrate your skills and get Funded in as quickly as 7
                    Days
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm">
                    Demonstrate discipline and consistency with our 2-step
                    evaluation
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm">
                    Choose our Instant Funded Account option.
                  </p>
                </motion.div>
              </div>
            )}
            ...
            {activeStep === 2 && (
              ...
              >
                ...
                >
                  ...
                  <p className="font-medium mb-2">
                    Create and verify your account to start earning
                  </p>
                  <p className="text-sm">
                    Start earning right away with simulated capital
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="font-medium mb-2">
                    Complete the evaluation process by meeting our achievable
                    targets
                  </p>
                  <p className="text-sm">
                    Demonstrate your trading prowess and get funded
                  </p>
                </motion.div>
              </div>
            )}
              ...
              <div className="grid grid-cols-1 gap-6" key="step3">
                ...
                >
                  ...
                  <p className="text-lg font-medium mb-2">
                    Once funded, you're ready to leverage our capital and start
                    maximizing your profits. Trade confidently, knowing we
      ...
      <div className="w-full font-inter bg-gray-50 mt-8 mb-8">
        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-12 md:py-16">
          ...
          {/* Platform Section */}
          <div className="mb-4 sm:mb-4 md:px-4">
            {/* Heading */}
            <motion.h2
      ...
      <div
        ...
        className="max-w-6xl mx-auto px-4 pt-4 mt-8 mb-8"
      >
        <motion.h2
          ...
          transition={{ duration: 0.5 }}
        >
          Why Traders Choose <span className="text-fuchsia-500">SFX </span>{" "}
          Funded
        </motion.h2>
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            ...
            >
              ...
              <p className="text-gray-700 text-sm sm:text-base">
                Trade your way! We don't limit your strategies, allowing you to
                use your preferred trading style and EAs freely.
              </p>
            </motion.div>
            ...
            <motion.div
              className="bg-[rgba(245,245,247,1)] rounded-xl p-6 sm:p-8 shadow-sm h-[180px] sm:h-[200px]"
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.15 }}
            >
