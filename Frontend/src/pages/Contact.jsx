...
>
        ...
        >
          <div>
            ...
            >
              ...
              <ul className="space-y-2 sm:space-y-4 text-gray-700 ml-2 sm:ml-4" 
                  style={{ 
                    fontFamily: 'Inter, sans-serif', 
                    fontSize: '16px', 
                    lineHeight: '1.7',
  ...
  <div className="flex items-center">
    <span className="mr-2">•</span>
    <span className="block sm:inline">Monday - Friday: 8 AM - 8 PM</span>
  </div>
  <div className="flex items-center ml-0 sm:ml-2 mt-1 sm:mt-0">
    ...
    <span>Saturday - Sunday: 9 AM - 5 PM</span>
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-6 mt-2 sm:mt-3" style={{ fontFamily: 'Inter, sans-serif' }}>
  {/* email */}
  <div className="flex items-start">
    ...
    }}>info@sfxfunded.com</span>
  </div>

  {/* location */}
  <div className="flex items-start">
    <img src="/loc.svg" alt="Location" className="h-6 w-6 mr-4 text-purple-600 mt-1" />
    <span className="text-gray-700 text-sm sm:text-base md:text-lg" style={{ lineHeight: '1.5' }}>7 Gower Street, London WC1E 6HA</span>
  </div>

  {/* phone */}
  <div className="flex items-start">
    <img src="/call.svg" alt="Phone" className="h-6 w-6 mr-4 text-purple-600 mt-1" />
    <span className="text-gray-700 text-sm sm:text-base md:text-lg" style={{ lineHeight: '1.5' }}>020 3666 0459</span>
  </div>
  {/* email */}
  <div className="flex items-start">
    <img src="/text.svg" alt="Phone" className="h-6 w-6 mr-4 text-purple-600 mt-1" />
    <span className="text-gray-700 text-sm sm:text-base md:text-lg" style={{ lineHeight: '1.5' }}>info@sfxfunded.com</span>
  </div>
  </div>
</div></div>
