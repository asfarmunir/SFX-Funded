...
export default function RapidChallenge() {
  ...
  const packages = {
    ...
    Builder: {
      0: {
        amount: "$293",
        freeAccounts: "Monthly Free 15k Challenge Account*",
      },
      10: {
        amount: "$587",
        freeAccounts: "Monthly Free 15k Challenge Account*",
    ...
    Leader: {
      0: {
        amount: "$367",
        freeAccounts: "Monthly Free 30k Challenge Account*",
      },
      10: {
        amount: "$734",
        freeAccounts: "Monthly Free 30k Challenge Account*",
    ...
    Elite: {
      0: {
        amount: "$428",
        freeAccounts: "Monthly Free 60k Challenge Account*",
      },
      10: {
        amount: "$856",
        freeAccounts: "Monthly Free 60k Challenge Account*",
  ...
  const testimonials = [
    {
      ...
      flag: "🇫🇷",
      rating: 5,
      text: "This is by far the best prop firm I have used; they are trustworthy and have excellent customer service. Since being with SFX Funded I have completed both evaluation and just received my first payout. The process was fast without any issues, I cannot recommend this company enough. It's clear they care about their traders.",
    },
    {
      id: 2,
      name: "John S.",
    ...
    },
    {
      ...
      flag: "🇦🇺",
      rating: 5,
      text: "I have just received my first reward of over $13k. SFX Funded is the real deal. Their rules are fair and easy to follow. The customer support is 2nd to none and I'm happy to recommend them to anyone. Trust is key in this industry and these guys have my full trust.",
    },
    {
      id: 5,
      name: "Ravi K.",
      flag: "🇮🇳",
      rating: 5,
      text: "SFX Funded is one of the best funding companies, there are no hidden rules that harm traders, there is a 2 step and lot rules. Rewards are fast and the support service is very friendly and responds quickly. SFX Funded is the best, I love it",
    },
    {
      id: 6,
      name: "Ahmed M.",
      flag: "🇦🇪",
      rating: 5,
      text: "Honestly, I've tried so many funded companies but what always disappointed me was their support team. Since I joined SFX Funded, I have had no complaints from the first day. What I love most about them is their hardworking team. WOW, WHAT A TEAM THEY ARE. Very quick, supportive and responsive. They will become the best funded company very soon.",
    },
    {
      id: 7,
      name: "Hans W.",
        ...
        <div className="max-w-7xl mx-auto text-center flex flex-col items-center justify-center mt-8 sm:mt-12 md:mt-16 lg:mt-20">
          ...
          >
            ...
            leading-tight tracking-tight"
              ...
              custom={0}
            >
              <motion.span variants={slideUp} custom={0.5}>
                Empower Your{" "}
              </motion.span>
              <motion.span
          ...
          <motion.p
            ...
            custom={2}
          >
            Partner with SFX Funded a top-tier, secure prop firm and earn a
            performance fee up to 17.5% commission
          </motion.p>
      ...
      <div className="font-['Inter'] max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-10 mb-20">
          ...
          >
            ...
            >
              Affiliate{" "}
              <span style={{ color: "rgba(248, 0, 234, 1)" }}>Program</span>
            </motion.h1>
            ...
            >
              Unmatched earning potential and the best partnership opportunities
              in the industry await you!
            </motion.p>
          ...
          >
            ...
            >
              ...
              />
              <p className="text-gray-700 lg:ml-6">
                Easily keep tabs on your revenue using our affiliate dashboard.
              </p>
            </motion.div>
            ...
            >
              ...
              />
              <p className="text-gray-700 lg:ml-6">
                Simply use your special link to promote using any methods
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="text-center mb-10">
          <h2
            className="text-3xl sm:text-4xl font-bold mb-2 font-['Inter']"
            style={{
              fontFamily: "'Inter', sans-serif",
            }}
          >
            Earn With The{" "}
            <span style={{ color: "rgba(248, 0, 234, 1)" }}>SFX Affiliate</span>{" "}
            Program
          </h2>
          <p
            className="text-gray-700 mb-10 font-['Inter']"
            style={{
              fontFamily: "'Inter', sans-serif",
            }}
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Starter Tier */}
          <div
            className="rounded-3xl p-6 flex flex-col items-center h-full font-['Inter']"
          ...
          >
            ...
            >
              Grab 10% commission on every referred purchase - credited to your
              account instantly!
            </p>
          ...
          >
            ...
            >
              Grab 12% commission on every referred purchase - credited to your
              account instantly!
            </p>
            ...
            <div className="w-full mb-6 flex-grow">
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                >
                  Monthly Free 15k Challenge Account*
                </span>
              </div>
            </div>
          ...
          >
            ...
            >
              Grab 15% commission on every referred purchase - credited to your
              account instantly!
            </p>
            ...
            <div className="w-full mb-6 flex-grow">
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                <span
                  ...
                  style={{ fontFamily: "'Inter',sans-serif" }}
                >
                  Monthly Free 30k Challenge Account*
                </span>
              </div>
            </div>
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "'Inter',sans-serif" }}
            >
              Grab 17.5% commission on every referred purchase - credited to
            ...
            <div className="w-full mb-6 flex-grow">
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                <span
                  ...
                  style={{ fontFamily: "'Inter',sans-serif" }}
                >
                  Monthly Free 60k Challenge Account*
                </span>
              </div>
            </div>
  ...
  /> */}
          ...
          >
            <motion.button
              ...
              style={{
                background:
                  "linear-gradient(135deg, #F800EA 0%, #DE00DE 50%, #C000B0 100%)",
                boxShadow:
                  "0 0 30px rgba(248, 0, 234, 0.5), 0 8px 32px rgba(0, 0, 0, 0.3)",
                fontFamily: "'Inter',sans-serif",
              }}
              whileHover={{
                scale: 1.08,
                boxShadow:
                  "0 0 40px rgba(248, 0, 234, 0.7), 0 12px 40px rgba(0, 0, 0, 0.4)",
              }}
              whileTap={{ scale: 0.95 }}
            >
              Contact SFX Funded
      ...
      <div className="font-sans max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-6">
          ...
          >
            Calculate Your{" "}
            <span className="text-[#F800EA]">Future Earnings</span>
          </h2>
          <p
        ...
        <div className="border-4 border-[#F800EA] rounded-3xl p-4 sm:p-6 px-4 sm:px-16 mb-8">
          <div className="grid grid-cols-4  w-full  justify-center gap-3 mb-8">
            <button
              className={`px-3 sm:px-6 py-2 rounded-md flex items-center justify-center gap-1 sm:gap-2 w-full h-[45px] ${
                selectedPackage === "Starter"
                  ? "bg-[#F800EA] text-white"
                  : "border border-[#F800EA] text-black"
              }`}
          ...
          <div className="mb-8 px-2 sm:px-0">
            <div className="relative w-full">
              ...
              <div className="relative w-full mt-6 text-sm h-6">
                ...
                <span
                  className={`absolute left-0 transform -translate-x-1/2 text-xs sm:text-sm ${
                    sliderValue === 0 ? "font-bold text-[#F800EA]" : ""
                  }`}
                >
                  5
                </span>
                <span
                  className={`absolute left-1/4 transform -translate-x-1/2 text-xs sm:text-sm ${
                    sliderValue === 10 ? "font-bold text-[#F800EA]" : ""
                  }`}
                >
                  10
                </span>
                <span
                  className={`absolute left-2/4 transform -translate-x-1/2 text-xs sm:text-sm ${
                    sliderValue === 20 ? "font-bold text-[#F800EA]" : ""
                  }`}
                >
                  20
                </span>
                <span
                  className={`absolute left-3/4 transform -translate-x-1/2 text-xs sm:text-sm ${
                    sliderValue === 50 ? "font-bold text-[#F800EA]" : ""
                  }`}
                >
                  50
                </span>
                <span
                  className={`absolute right-0 transform translate-x-1/2 text-xs sm:text-sm ${
                    sliderValue === 100 ? "font-bold text-[#F800EA]" : ""
                  }`}
                >
                  100
                </span>
          ...
          <div className="mt-8 sm:mt-12 overflow-x-auto">
            <div className="min-w-full">
              <div
                className="grid grid-cols-3 text-white rounded-t-lg"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  backgroundColor: "rgba(248, 0, 234, 1)",
                }}
              >
                <div className="py-3 px-2 sm:px-4 text-center font-medium text-sm sm:text-base">
                  Package
                </div>
                <div className="py-3 px-2 sm:px-4 text-center font-medium text-sm sm:text-base">
                  Amount
              ...
              <div className="grid grid-cols-3 border-b border-gray-200">
                <div className="py-3 px-2 sm:px-4 text-center text-sm sm:text-base">
                  {selectedPackage}
                </div>
                <div className="py-3 px-2 sm:px-4 text-center text-sm sm:text-base">
                  {packages[selectedPackage][sliderValue]?.amount || "N/A"}
                </div>
                <div className="py-3 px-2 sm:px-4 text-center text-sm sm:text-base">
                  {packages[selectedPackage][sliderValue]?.freeAccounts ||
                    "None"}
                </div>
              </div>
            </div>
      ...
      <div className="my-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch mb-6 lg:mb-8 gap-6 lg:gap-2">
          ...
          <div className="border-[1.82px] border-[#20242B] rounded-xl p-6 w-full lg:w-1/3 mx-0 lg:mx-2 h-auto flex flex-col">
            <div className="flex items-center mb-3">
              <img
                ...
                alt="Personalized Link"
                className="w-8 h-8 mr-3"
              />
              <h3 className="text-xl font-bold">Personalized Link</h3>
            </div>
            <p className="text-sm text-gray-600 flex-grow">
              Access Your Personal Affiliate Link
            </p>
          </div>
          ...
          <div className="border-[1.82px] border-[#20242B] rounded-xl p-6 w-full lg:w-1/3 mx-0 lg:mx-2 h-auto flex flex-col">
            ...
            <p className="text-sm text-gray-600 flex-grow">
              Promote SFX Funded To Your Network & Start Earning
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-center items-stretch mt-0 lg:mt-4 gap-6 lg:gap-2">
          ...
          <div className="border-[1.82px] border-[#20242B] rounded-xl p-6 w-full lg:w-1/3 mx-0 lg:mx-2 h-auto flex flex-col">
            ...
            <p className="text-sm text-gray-600 flex-grow">
              Watch Your Earnings Growth In Our Dashboard
            </p>
          </div>
          ...
          <div className="border-[1.82px] border-[#20242B] rounded-xl p-6 w-full lg:w-1/3 mx-0 lg:mx-2 h-auto flex flex-col">
            ...
            <p className="text-sm text-gray-600 flex-grow">
              Request Payout And Get Paid Within 24 Hours
            </p>
          </div>
        </div>
