...
export default function InstantFunding() {
  ...
  return (
    <div className="font-inter w-full ">
      {/* HERO SECTION */}
      <div
        className="w-full mx-0 px-4 pt-6 pb-0 rounded-[40px] mt-6 mb-8 sm:my-6 relative overflow-hidden"
        style={{
          background:
  ...
  leading-none tracking-tight mt-3 sm:mt-4 md:mt-5"
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
            ...
            >
              <h2 className="text-[#DE00DE] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <span className="text-[#080308] font-semibold">
                  IN 3 SIMPLE STEPS
                </span>
              </h2>
                ...
                >
                  ...
                  >
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                      ...
                      <p className="text-sm sm:text-lg text-black font-semibold sm:font-medium">
                        Get instant access to your funded account and start
                        trading immediately. No waiting, no targets.
                      </p>
                    </div>
                ...
                >
                  ...
                  >
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                      ...
                      <p className="text-sm sm:text-lg text-black font-semibold sm:font-medium">
                        Start earning from day one and receive up to 100% reward
                        split, paid bi-weekly.
                      </p>
                    </div>
      ...
      >
        ...
        >
          ...
          <p className="text-xl">
            Compare the rapid challenge with the 1-Step Model
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <h2 className="text-3xl font-bold mb-12">Instant Funding</h2>

            <div className="space-y-8 text-left">
              <div className="flex items-start gap-4">
                <span className="text-2xl mt-1">✅</span>
                <div>
                  <p className="font-bold text-fuchsia-500 text-xl mb-2">
                    Immediate Capital
                  </p>
                  <p className="text-gray-700 text-lg">
                    Start trading in minutes with real capital.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-lg">
                    Get paid bi-weekly with up to 100% profit split.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-lg">
                    No targets, no waiting, instant access.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 text-left">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-lg">
                    Must pass 1 or 2 phase evaluation first.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-lg">
                    Earn only after passing all evaluation phases.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-fuchsia-500 text-xl mb-2">
                    Strict Rules & Targets
                  </p>
                  <p className="text-gray-700 text-lg">
                    Must hit profit goals without violating rules.
                  </p>
                </div>
              </div>
            </div>
      ...
      >
        ...
        >
          ...
          <p className="text-base font-medium text-gray-700">
            Here are key benefits that make SFX funded the best instant funding
            prop firm
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="flex justify-center mt-4">
                <img
                  src="/shield.svg"
                  alt="Shield"
                  className="w-20 h-20 text-fuchsia-500"
                />
              </div>
            </motion.div>
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <div className="flex items-center justify-center mt-4">
            ...
            />
            <span className="text-[#D90BC6]  font-medium text-xl">
        ...
        <div className="mt-8 border border-fuchsia-200 rounded-2xl overflow-hidden bg-white">
          ...
          <div className="grid grid-cols-2 border-b border-gray-200">
            ...
            <div className="text-center py-3 text-[#D90BC6] font-medium">
              Funded
            </div>
          </div>
          <div className="grid grid-cols-2 border-b border-gray-200 ">
        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-12 md:py-16">
          ...
          <div className="mb-16 px-4">
            ...
            >
              ...
              simulate real market conditions with spreads from 0 pips and with
