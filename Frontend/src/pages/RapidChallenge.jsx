...
export default function RapidChallenge() {
  ...
  "
      ...
      leading-none tracking-tight mt-2 sm:mt-4 md:mt-5"
              style={{
                fontFamily: "Oswald, sans-serif",
                fontWeight: 600,
          ...
          >
            Your fastest path to SFX Funded Trader, hit a 5% target and unlock
            accounts up to $120,000
          </motion.p>
                ...
                >
                  ...
                  >
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                      ...
                      <p className="text-sm sm:text-lg text-black font-semibold sm:font-medium">
                        Meet the 5% profit target with zero minimum trading days
                        required.
                      </p>
                    </div>
                ...
                >
                  ...
                  >
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                      ...
                      <p className="text-sm sm:text-lg text-black font-semibold sm:font-medium">
                        Trade our funds and earn your first payout on demand
                        with up to 100% performance split.
                      </p>
                    </div>
      ...
      >
        ...
        >
          ...
          <p className="text-xs sm:text-base md:text-lg lg:text-xl text-center mx-auto max-w-md sm:max-w-lg">
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-left">
                    <span className="text-fuchsia-500">$550 for $100K</span>{" "}
                    Evaluation
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-left">
                    <span className="text-fuchsia-500">$338 for $120K</span>{" "}
                    Evaluation
                  </p>
                </div>
              </div>
      ...
      <div
        className="font-sans max-w-6xl mx-auto px-4 py-12 sm:py-16 mt-4 mb-4"
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-6 h-full">
            ...
            >
              ...
              <div className="flex justify-center">
                <img src="/shield.svg" alt="Shield" className="w-20 h-20" />
              </div>
            </motion.div>
          ...
          <div className="flex flex-col gap-6 h-full">
            ...
            >
              ...
              <p className="text-lg text-gray-700">
                Mistakes happen! This feature enables you to reset your account
                as an SFX Funded Trader.
              </p>
            </motion.div>
      ...
      <div className="font-sans max-w-6xl mx-auto px-4 py-12 mb-4 mt-4">
        ...
        <div className="text-center mb-6">
          ...
          <div className="flex items-center justify-center mt-4">
            ...
            />
            <span className="text-[#D90BC6] font-medium text-lg">
              Fast Track to Becoming Funded
            </span>
          </div>
        </div>
        {/* Account Table */}{" "}
