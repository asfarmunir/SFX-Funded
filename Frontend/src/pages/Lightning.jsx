...
export default function LightningChallenge() {
  ...
  "
          ...
          >
            Designed for confident traders seeking the fastest and most
            accessible track to prove their skills and get funded.
          </motion.p>
                ...
                >
                  ...
                  >
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                      ...
                      <p className="text-sm sm:text-lg text-black font-semibold sm:font-medium">
                        Prove your skills by meeting the trading objective in
                        just 7 days.
                      </p>
                    </div>
                ...
                >
                  ...
                  >
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                      ...
                      <p className="text-sm sm:text-lg text-black font-semibold sm:font-medium">
                        Trade our funds and start earning up to 90% performance
                        split.
                      </p>
                    </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            ...
            >
              ...
              <div className="mb-0 sm:mb-2 text-base sm:text-lg">
                <span className="font-semibold">Experienced traders</span>{" "}
                seeking the conventional route to funding
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mb-3 sm:mb-4 font-semibold text-lg sm:text-xl">
                Start from $59 /{" "}
                <span className="text-[#DE00DE]">$10K Evaluation</span>
              </div>
              <div className="mb-0 sm:mb-2 text-base sm:text-lg">
                <span className="text-[#DE00DE] font-bold">
                  Confident traders
                </span>{" "}
                seeking a faster and more accessible evaluation program
              </div>
            </motion.div>
          </div>
        </div>
              ...
              >
                <div className="pr-14">
                  ...
                  <p className="text-lg sm:text-xl text-green-600">
                    Choose Account sizes up to $100k and earn up to 90%
                    performance split.
                  </p>
                </div>
                <div className="absolute top-6 right-6">
                  <img src="/dollar.svg" alt="Dollar" className="w-10 h-10" />
                </div>
              </motion.div>
              ...
              >
                <div className="pr-16">
                  ...
                  <p className="text-lg sm:text-xl">
                    Prove your skills just once by meeting all the trading
                    objective in 7 days.
                  </p>
                </div>
                <div className="absolute top-6 right-6">
            ...
            <div className="w-full lg:w-1/3 flex flex-col gap-6 sm:gap-8">
              ...
              >
                <div className="pr-16">
                  ...
                  <p className="text-lg sm:text-xl">
                    Customize your account for the best experience with your
                    unique add-ons at checkout.
                  </p>
                </div>
                <div className="absolute top-6 right-6">
                  <img
              ...
              >
                <div className="pr-16">
                  ...
                  <p className="text-lg sm:text-xl text-fuchsia-500">
                    Trade on the most popular platform in the industry. Stick to
